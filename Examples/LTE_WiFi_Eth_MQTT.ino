// This is Demo Code that is present on all shipped Vajruino boards
// This example code demonstrates how to read chip temperature reading from on-board DS3231 RTC module and save it to an SD card along with a timestamp.
